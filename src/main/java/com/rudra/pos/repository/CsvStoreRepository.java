...
/** CSV-backed {@link StoreRepository}, persisting to {@code stores.csv}. */
public class CsvStoreRepository extends AbstractCsvRepository<Store> implements StoreRepository {

    public CsvStoreRepository(Path dataDir) {
